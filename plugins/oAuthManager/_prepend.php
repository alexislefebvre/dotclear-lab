...
$__autoload['oAuthClientStore'] = dirname(__FILE__).'/inc/lib.oauth.client.store.php';
# oAuth 1.0a libraries$__autoload['oAuthClient10'] = dirname(__FILE__).'/inc/lib.oauth.client.1.0.php';
# oAuth 2.0 draft 10 librairies
$__autoload['oAuthClient20'] = dirname(__FILE__).'/inc/lib.oauth.client.2.0.php';
