...
$GLOBALS['__l10n']['This means that with this service short links start with "%s".'] = 'Cela signifie qu\'avec ce service vos liens courts commence par "%s".';

#inc/services/class.local.service.php:50
$GLOBALS['__l10n']['You can use Dotclear\'s plugin called myUrlHandlers to change short links prefix on your blog.'] = 'Vous pouvez utiliser l\'extension myUrlHandlers pour Dotclear afin de changer le prefix de vos liens court depuis votre blog.';
...
$GLOBALS['__l10n']['Allowed protocols:'] = 'Protocols autorisés :';
...
$GLOBALS['__l10n']['Enable public page for visitors to shorten links'] = 'Activier la page publique pour que les visiteurs puissent réduire des liens';
