...
<head>
	...
	<?php echo dcPage::jsLoad('index.php?pf=flvplayer_config/js/generator.js'); ?>
	<link rel="stylesheet" href="index.php?pf=flvplayer_config/style.css" type="text/css" />
</head>
<body>
			...
			<div class="multi-part" id="generale" title="<?php echo __('Générale'); ?>">
				<table class="visible" summary="Générale">
					...
					<tr><td class="name"><label for="title">title</label></td>
						<td class="value"><input type="text" value="<?php echo $args['title']; ?>" class="text" name="title" id="title"></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'Le titre affiché avant le chargement de la vidéo')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					<tr><td class="name"><label for="startimage">startimage</label></td>
						<td class="value"><input type="text" value="<?php echo $args['startimage']; ?>" class="url" name="startimage" id="startimage"></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'L\'URL du fichier JPEG (non progressif) à afficher avant le chargement de la vidéo')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					<tr><td class="name"><label for="width">width</label></td>
						<td class="value"><input type="text" value="<?php echo $args['width']; ?>" class="int" name="width" id="width"></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'Forcer la largeur du lecteur')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					<tr><td class="name"><label for="height">height</label></td>
						<td class="value"><input type="text" value="<?php echo $args['height']; ?>" class="int" name="height" id="height"></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'Forcer la hauteur du lecteur')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					<tr><td class="name"><label for="loop">loop</label></td>
						<td class="value"><input name="loop" id="loop" type="checkbox" <?php echo $args['loop']? 'checked="checked"':''; ?>/></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, '&lt;code&gt;1&lt;/code&gt; pour boucler')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					<tr><td class="name"><label for="autoplay">autoplay</label></td>
						<td class="value"><input name="autoplay" id="autoplay" type="checkbox" <?php echo $args['autoplay']? 'checked="checked"':''; ?>/></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, '&lt;code&gt;1&lt;/code&gt; pour lire automatiquement')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
					...
					<tr><td class="name"><label for="buffer">buffer</label></td>
						...
						</select></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'Le nombre de secondes pour la mémoire tampon. Par défaut à &lt;code&gt;5&lt;/code&gt;.')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
				    </tbody>
				</table>
			</div>
			...
			<div class="multi-part" id="bordure" title="<?php echo __('Bordure'); ?>">
				<table class="hidden" summary="Bordure">
					...
					<tr><td class="name"><label for="skin">skin</label></td>
						<td class="value"><input type="text" value="<?php echo $args['skin']; ?>" class="url" name="skin" id="skin"></td><td class="actions"><a onmouseout="tooltip.hide()" onmouseover="tooltip.show(this, 'L\'URL du fichier JPEG (non progressif) à charger')" href="javascript:void(0)"><img alt="Help" src="index.php?pf=flvplayer_config/help.png"></a></td></tr>
