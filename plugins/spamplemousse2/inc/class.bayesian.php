...
# -- BEGIN LICENSE BLOCK ----------------------------------
#
# This file is part of Spamplemousse2, a plugin for Dotclear 2 2.
#
...
class bayesian
{
	...
	*/
	private function basic_train_unit($t, $spam, $retrain = false) {
		...
		if ($known_token) {
			$token = array('token_id' => $t, 'token_nham' => $rs->token_nham, 'token_nspam' => $rs->token_nspam, 'token_p' => $rs->token_p, 'token_mature' => $rs->token_mature);			
		}
