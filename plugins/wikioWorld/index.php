...
$active = (boolean) $core->blog->settings->wikioWorld->wikioWorld_active;
$entryvote_active = (boolean) $core->blog->settings->wikioWorld->wikioWorld_entryvote_active;
$entryvote_style = (string) $core->blog->settings->wikioWorld->wikioWorld_entryvote_style;
$entryvote_place = (string) $core->blog->settings->wikioWorld->wikioWorld_entryvote_place;
$blogrss_active = (boolean) $core->blog->settings->wikioWorld->wikioWorld_blogrss_active;
$blogrss_style = (string) $core->blog->settings->wikioWorld->wikioWorld_blogrss_style;
$addwikio_active = (boolean) $core->blog->settings->wikioWorld->wikioWorld_addwikio_active;
$toprank_active = (boolean) $core->blog->settings->wikioWorld->wikioWorld_toprank_active;
$toprank_cat = (string) $core->blog->settings->wikioWorld->wikioWorld_toprank_cat;
...
if ($action == 'savesetting')
{
	try
	{
		...
		$core->blog->settings->wikioWorld->put('wikioWorld_active',$active,'boolean');
		$core->blog->settings->wikioWorld->put('wikioWorld_entryvote_active',$entryvote_active,'boolean');
		$core->blog->settings->wikioWorld->put('wikioWorld_entryvote_style',$entryvote_style,'string');
		$core->blog->settings->wikioWorld->put('wikioWorld_entryvote_place',$entryvote_place,'string');
		$core->blog->settings->wikioWorld->put('wikioWorld_blogrss_active',$blogrss_active,'boolean');
		$core->blog->settings->wikioWorld->put('wikioWorld_blogrss_style',$blogrss_style,'string');
		$core->blog->settings->wikioWorld->put('wikioWorld_addwikio_active',$addwikio_active,'boolean');
		$core->blog->settings->wikioWorld->put('wikioWorld_toprank_active',$toprank_active,'boolean');
		$core->blog->settings->wikioWorld->put('wikioWorld_toprank_cat',$toprank_cat,'string');
...
if ($default_part == 'backlinks')
{
	...
	<body>
	<h2>'.html::escapeHTML($core->blog->name).' &rsaquo; '.__('Wikio world').'</h2>'.
	...
	'style=raw&country='.$core->blog->settings->system->lang.
