...
if ($core->blog->settings->saba->active) {
	...
	$core->url->register('search','search','^search(/.+)?$',array('urlSaba','saba'));
	...
	$core->tpl->addValue('SabaFormTypes',array('tplSaba','SabaFormTypes'));
	$core->tpl->addValue('SabaFormAges',array('tplSaba','SabaFormAges'));
	$core->tpl->addValue('SabaFormOrders',array('tplSaba','SabaFormOrders'));
	$core->tpl->addValue('SabaFormAuthors',array('tplSaba','SabaFormAuthors'));
	$core->tpl->addValue('SabaPaginationURL',array('tplSaba','SabaPaginationURL'));
	$core->tpl->addValue('SabaURL',array('tplSaba','SabaURL'));
	# behavior
	$core->addBehavior('templateCustomSortByAlias',array('pubSaba','templateCustomSortByAlias'));
	$core->addBehavior('urlHandlerBeforeGetData',array('pubSaba','urlHandlerBeforeGetData'));
	$core->addBehavior('corePostSearch',array('pubSaba','corePostSearch'));
...
class tplSaba
{
	...
	public static function SabaFormCategories($a)
	{
		...
		while ($rs->fetch()) {
			if (in_array($rs->cat_id,$dis) || in_array($rs->cat_url,$dis)) continue;
	...
	public static function SabaFormAuthors($a)
	{
		...
		while ($rs->fetch()) {
			if (in_array($rs->user_id,$dis)) continue;
