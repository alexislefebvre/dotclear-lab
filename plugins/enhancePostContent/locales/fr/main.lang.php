<?php
// Language: français 
// Module: enhancePostContent - 0.8
// Date: 2010-03-31 00:47:07 
...
#inc/lib.epc.php:192
$GLOBALS['__l10n']['Highlight citation of people. First term of the list is the citation and second term the author.'] = 'Met en avant les citation des gens. Le premier terme est la citation et le seond terme est l\'auteur.';

#inc/lib.epc.php:212
$GLOBALS['__l10n']['Link some words. First term of the list is the term to link and second term the link.'] = 'Ajouter des liens. Le premier terme de la liste est le texte à lier et le seconde terme et l\'adresse de lien.';
...
#index.php:229
$GLOBALS['__l10n']['Parts to be filtered'] = 'Parties à filtrer';
...
#index.php:353
$GLOBALS['__l10n']['Record successfully added'] = 'Enregistrement ajouté avec succès';

#index.php:356
$GLOBALS['__l10n']['Records successfully updated'] = 'Enregistrements mis à jour avec succès';

#index.php:360
$GLOBALS['__l10n']['No record'] = 'Pas d\'enregistrement';

#index.php:392
$GLOBALS['__l10n']['In order to remove a record, leave empty its key or value.'] = 'Pour retirer un enregistrement, laiser vide sa clé ou sa valeur.';
...
#index.php:434
$GLOBALS['__l10n']['Settings of enhancePostContent'] = 'Paramètres de enhancePostContent';
...
#index.php:445
$GLOBALS['__l10n']['This also actives widget'] = 'Ceci active également le widget';

#index.php:451
$GLOBALS['__l10n']['This is a special feature to edit list of allowed template values and public pages where this plugin works.'] = 'Ceci est une option sépciale pour modifier les listes des balises de template et des pages publiques ou le plugin sera actif.';
