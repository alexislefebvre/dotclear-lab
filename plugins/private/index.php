...
if (!empty($_POST['saveconfig']))
{
	try
	{
		...
		$private_conauto_flag = (empty($_POST['private_conauto']))?false:true;
		...
		$blog_private_pwd = md5($_POST['blog_private_pwd']);
 		...
 		$s->put('private_conauto',$private_conauto_flag,'boolean','Private mode automatic connection option');
...
'</label></p>
<p>'.
form::checkbox('private_conauto', 1, $private_conauto_flag).
