	...
	<xsl:element name="draw:frame">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
                ...
                <!--
				<xsl:attribute name="svg:width">function:getimage-width:(<xsl:value-of select="@src"/>)</xsl:attribute>
				<xsl:attribute name="svg:height">function:getimage-height:(<xsl:value-of select="@src"/>)</xsl:attribute>
                -->
