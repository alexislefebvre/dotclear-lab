...
class MyFormsTextField extends MyFormsField
{
  ...
  public function Display() {
    return "<input type='text' ".$this->AttributesAsString()." value='".$this->ValueDisplay()."' />";
  }
  
  public static function Register() {
    global $core;
    $core->tpl->addBlock('myformsTextField',array('MyFormsTextField','TplDisplay'));
    $core->tpl->addBlock('myformsTextField_Declare',array('MyFormsTextField','TplDeclare'));
  }
