...
*/
		...
		_mceInsertAnchor : function(ui, v) {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/anchor.htm',
		...
		_mceCharMap : function() {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/charmap.htm',
		...
		_mceHelp : function() {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/about.htm',
				width : 480,
				height : 380,
				inline : true
			}, {
		...
		_mceColorPicker : function(u, v) {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/color_picker.htm',
		...
		_mceCodeEditor : function(ui, val) {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/source_editor.htm',
		...
		_mceImage : function(ui, val) {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/image.htm',
		...
		_mceLink : function(ui, val) {
			...
			ed.windowManager.open({
				url : 'plugin.php?p=tinyMce&tinyMce_file=/themes/advanced/link.htm',
