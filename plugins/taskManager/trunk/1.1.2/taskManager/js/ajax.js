...
function publicShow(id,state)
{
	...
	$("#taskId"+id+" .taskvisibility").replaceWith('<td onclick="'+renew+'" class="taskvisibility action"><input type="checkbox" '+check+' onmouseover="showinfo(\''+task_visibility_text+'\')"/></td>');
}
