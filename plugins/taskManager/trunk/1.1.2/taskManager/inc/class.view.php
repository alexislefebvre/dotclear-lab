...
class View
{
	...
	public function js() {
		...
		<script type="text/javascript">
		      ...
		      var task_visibility_text = "'.__('Show/Hide on the blog').'";
	...
	<td onclick="cancel('.$id.',0)" class="hidetask action">
		<img src="index.php?pf=taskManager/img/arrow_undo.png" onmouseover="showinfo(\''.__('remove modifications').'\')"/></td>
	<td onclick="modify('.$id.',0)" class="showtask action">
		<img src="index.php?pf=taskManager/img/note_edit.png" onmouseover="showinfo(\''.__('modify').'\')"/></td>
	<td class="addobj action">
		<img onclick="showNewObj('.$id.')" src="index.php?pf=taskManager/img/pencil_add.png" class="addobjplus" onmouseover="showinfo(\''.__('add a task').'\')"/>
		<img onclick="hideNewObj('.$id.')" src="index.php?pf=taskManager/img/pencil_delete.png" class="addobjminus" onmouseover="showinfo(\''.__('Do not add a task').'\')" />
	</td>
	<td class="taskvisibility action" onclick="publicShow('.$id.','.$taskpublicview.')">
		<input type="checkbox" '.$checked.' onmouseover="showinfo(task_visibility_text)"/>
	</td>
...
<tr class="objLine new" id="objId'.$order.'">
	...
	<td onclick="cancel('.$order.',1,'.$taskId.')" class="hideobj action">
		<img src="index.php?pf=taskManager/img/arrow_undo.png" onmouseover="showinfo(\''.__('remove modifications').'\')" />
	</td>
	<td onclick="modify('.$order.',1,'.$taskId.')" class="showobj action">
		<img src="index.php?pf=taskManager/img/note_edit.png" onmouseover="showinfo(\''.__('modify').'\')" />
	</td>
	...
	return '<tr class="taskLine new" id="taskId'.$taskId.'">
		...
		<td onclick="modify('.$taskId.',0)" class="showtask action">
			<img src="index.php?pf=taskManager/img/note_edit.png" onmouseover="showinfo(\''.__('modify').'\')" /></td>
		<td class="addobj action">
			<img onclick="showNewObj('.$taskId.')" src="index.php?pf=taskManager/img/pencil_add.png" class="addobjplus" onmouseover="showinfo(\''.__('add a task').'\')" />
			<img onclick="hideNewObj('.$taskId.')" src="index.php?pf=taskManager/img/pencil_delete.png" class="addobjminus" onmouseover="showinfo(\''.__('do not add a task').'\')" />
		</td>
	<td class="taskvisibility action" onclick="publicShow('.$id.',1)">
		<input type="checkbox" '.$checked.' onmouseover="showinfo(task_visibility_text)"/>
	</td>
