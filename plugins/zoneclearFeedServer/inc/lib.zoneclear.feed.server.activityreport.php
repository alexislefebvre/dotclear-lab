...
$core->activityReport->addGroup('zoneclearFeedServer',__('Plugin zoneclearFeedServer'));
...
class zoneclearFeedServerActivityReportBehaviors
{
	public static function addFeed($cur)
	{
		...
		$core->activityReport->addLog('zoneclearFeedServer','create',$logs);
	}
	public static function updFeedInfo($cur,$id)
	{
		if (defined('DC_CONTEXT_ADMIN'))
		{
			...
			$core->activityReport->addLog('zoneclearFeedServer','updatefeedinfo',$logs);
		}
	}
	...
	public static function enableFeed($id,$enable,$time)
	{
		...
		$core->activityReport->addLog('zoneclearFeedServer','status',$logs);
	}
}
?>