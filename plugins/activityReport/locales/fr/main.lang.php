...
$GLOBALS['__l10n']['New 404 error page at "%s"'] = 'Nouvelle erreur 404 à "%s"';

#inc/class.activity.report.behaviors.php:60
...
$GLOBALS['__l10n']['A new post called "%s" was created by "%s" at %s'] = 'Nouveau billet nommé "%s" crée par "%s" à %s';
...
$GLOBALS['__l10n']['Post called "%s" have been deleted by "%s"'] = 'Billet nommé "%s" supprimé par "%s"';
...
$GLOBALS['__l10n']['comment creation'] = 'Création de commentaitre';

#inc/class.activity.report.behaviors.php:108
$GLOBALS['__l10n']['A new comment was created by "%s" on post "%s" at %s'] = 'Nouveau commentaire créé par "%s" sur le billet "%s" à %s';
...
$GLOBALS['__l10n']['Comment have been updated by "%s" at %s'] = 'Commentaire mis à jour par "%s" à %s';
...
$GLOBALS['__l10n']['A new trackback to "%" at "%s" was created on post "%s" at %s'] = 'Nouveau trackback vers "%s" à %s crée sur le billet "%s" a %s';

#inc/class.activity.report.behaviors.php:141
$GLOBALS['__l10n']['Actions on categories'] = 'Actions sur les catégories';

#inc/class.activity.report.behaviors.php:147
$GLOBALS['__l10n']['category creation'] = 'Création de catégorie';

#inc/class.activity.report.behaviors.php:148
$GLOBALS['__l10n']['A new category called "%s" was created by "%s" at %s'] = 'Nouvelle catégorie nommé "%s" crée par "%s" à %s';
...
$GLOBALS['__l10n']['Category called "%s" have been updated by "%s" at %s'] = 'Catégorie nommé "%s" mise à jour à %s';

#inc/class.activity.report.behaviors.php:168
$GLOBALS['__l10n']['Actions on users'] = 'Actions sur les utilisateurs';

#inc/class.activity.report.behaviors.php:174
$GLOBALS['__l10n']['user creation'] = 'Création d\'utilisateur';

#inc/class.activity.report.behaviors.php:175
$GLOBALS['__l10n']['A new user named "%s" was added by "%s"'] = 'Nouvel utilisateur nommé "%s" créé par "%s"';
...
$GLOBALS['__l10n']['User named "%s" have been updated by "%s"'] = 'Utilisateur nommé "%s" mis à jour par "%s"';
...
$GLOBALS['__l10n']['User named "%s" have been deleted by "%"'] = 'Utilisateur nommé "%s" supprimé par "%s"';
...
#inc/class.activity.report.php:422
...
#inc/lib.activity.report.index.php:83
