...
class adminlistCinecturlink2 extends adminGenericList
{
	...
	private function linkLine($url,$loop)
	{
		...
		"</td>\n".
		'<td class="nowrap">'.
		'<a href="plugin.php?p=cinecturlink2&amp;part=main&amp;tab=newlink&amp;link_id='.$this->rs->link_id.'" title="'.__('Edit').'"><img src="index.php?pf=cinecturlink2/inc/img/icon-edit.png" alt="'.__('Edit').'" /></a>'.
		"</td>\n".
		'</tr>'."\n";
	}
}
