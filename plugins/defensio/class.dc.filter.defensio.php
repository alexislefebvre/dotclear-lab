...
class dcFilterDefensio extends dcSpamFilter
{
	...
	public function gui($url)
	{
		...
		$defensio_key = $blog->settings->defensio_key;
		...
		if (isset($_POST['defensio_key']))
		{
			try
			{
				...
				$blog->settings->setNameSpace('defensio');
				$blog->settings->put('defensio_key',$defensio_key,'string');
		...
		{
			try {
				$defensio = new defensio($blog->url,$blog->settings->defensio_key);
