...
$('#edit-entry').onetabload(function(){$('#post-wtext-form p#post-wtext-head').toggleWithLegend($('#post-wtext-form').children().not('p#post-wtext-head'),{fn:function(){postWidgetTextTb.switchMode(formatAddField.value);},cookie:'dcx_post_wtext',hide:$('#post-wtext-form').val()==''});});
});