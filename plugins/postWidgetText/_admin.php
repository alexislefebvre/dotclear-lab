...
# Plugin "importExport"
if ($core->blog->settings->postwidgettext_importexport_active)
{
...
class postWidgetTextBackupBehaviors
{
	public static function exportSingle($core,$exp,$blog_id)
	{
		$exp->export('postwidgettext',
			'SELECT option_type, option_content, option_content_xhtml, option_words, W.post_id '.
