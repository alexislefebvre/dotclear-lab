...
$core->addBehavior('adminAfterPostUpdate',array('myGmapsPostBehaviors','adminAfterPostUpdate'));
...
class myGmapsPostBehaviors
{
	...
	public static function adminAfterPostUpdate()
	{
		if ($_GET['remove'] == 'ok') {
			echo '<p class="message">'.__('Map has been successfully deleted.').'</p>';
		}
	}
}   
?>