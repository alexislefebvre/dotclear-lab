$(function () {
    ...
    if (document.getElementById('map_canvas'))
    {
        ...
        //Place marker
		var icon = new google.maps.MarkerImage("index.php?pf=myGmaps/icons/target_icon.png", null, null, new google.maps.Point(32, 32));
		...
		$('#map-options').submit(function() {
			...
			$('input[name=myGmaps_center_upd]').attr('value',default_location);
			$('input[name=myGmaps_zoom_upd]').attr('value',default_zoom);
			$('input[name=myGmaps_type_upd]').attr('value',default_type);
			return true;
