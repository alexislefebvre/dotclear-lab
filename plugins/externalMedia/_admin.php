...
$core->addBehavior('adminPostHeaders',array('externalMediaBehaviors','postHeaders'));
$core->addBehavior('adminRelatedHeaders',array('externalMediaBehaviors','postHeaders'));
