...
$(function(){
	...
	/* fieldset to button */
	var sosForm=$('#setting-form');
	if (sosForm!=undefined){
		dotclear.jcTools.formFieldsetToMenu(sosForm);
	}
	/* fieldset to button */
	var sobForm=$('#buttons-form');
	if (sobForm!=undefined){
		dotclear.jcTools.formFieldsetToMenu(sobForm);
	}
});
