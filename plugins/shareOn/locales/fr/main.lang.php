...
#index.php:136
$GLOBALS['__l10n']['Please note that this button is loaded at same time of the page and can slow down your blog. It depends on the response time of service.'] = 'Notez que ce bouton est chargé en même temps que la page et peut ralenti votre blog. Cela dépend du temps de réponse du service.';

#index.php:140
$GLOBALS['__l10n']['This button uses javascript to call service and does not slow down your blog. You must have jQuery loaded in your theme.'] = 'Ce bouton utilise javascript, il ne ralentie pas la page. vous devez avoir jQuery chargé dans votre thème.';
...
#index.php:188
$GLOBALS['__l10n']['You can add here special cascading style sheet. Share on bar has class "shareonentry" and widget has class "shareonwidget".'] = 'Vous pouvez ajouter ici des styles spécificques. La barre ShareOn utilise la class "shareonentry" et le widget utilise la class "shareonwidget".';
