...
class libPackman
{
	...
	public static function tab($modules,$type=null,$redir=null,$extern=true)
	{
		...
		if ($extern)
		{
			echo '<div class="multi-part" id="packman-'.$type.'" title="'.
	...
	public static function repo($modules,$type)
	{
		...
		else
		{
			...
			{
				if (isset($dup[$module['root']])) continue;
				$dup[$module['root']] = 1;
