...
<?php if (!empty($msg)) echo '<p class="message">'.$msg.'</p>' ?>
	<div class="multi-part" id="tab_settings" title="<?php echo __('Settings'); ?>"><?php tabsNewsletter::Settings() ?></div>
	<div class="multi-part" id="tab_listblog" title="<?php echo __('Subscribers'); ?>"><?php tabsNewsletter::ListBlog() ?></div>
	<div class="multi-part" id="tab_addedit" title="<?php echo (!empty($_POST['id'])) ? __('Edit') : __('Add'); ?>"><?php tabsNewsletter::AddEdit() ?></div>
	<div class="multi-part" id="tab_usage" title="<?php echo __('Usage'); ?>"><?php tabsNewsletter::Usage() ?></div>
	<div class="multi-part" id="tab_about" title="<?php echo __('About'); ?>"><?php tabsNewsletter::About() ?></div>
</body>
</html>
