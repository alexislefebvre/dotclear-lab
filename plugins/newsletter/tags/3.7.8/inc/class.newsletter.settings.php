...
class newsletterSettings
{
	...
	*/
	...
	/**
	* retourne le flag Restreindre l'aper�u uniquement � l'extrait des billets
	*/
	...
	/**
	* positionne le flag Restreindre l'aper�u uniquement � l'extrait des billets
	*/
	...
	/**
	* initialise le flag Restreindre l'aper�u uniquement � l'extrait des billets
	*/
